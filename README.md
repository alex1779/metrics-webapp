...
# 📖 React capstone project - Metrics webapp: initialize project with components. <a name="about-project"></a>
...
```sh
  cd my-folder
  git clone https://github.com/alex1779/metrics-webapp.git
```
...
Webpage: [@handle](https://www.behance.net/sakwadesignstudio)
